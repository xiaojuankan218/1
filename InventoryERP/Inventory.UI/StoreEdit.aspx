<%@ Page Title="" Language="C#" MasterPageFile="~/Inventory.Master" AutoEventWireup="true" CodeBehind="StoreEdit.aspx.cs" Inherits="Inventory.UI.StoreEdit" EnableEventValidation="false"%>
                        ...
                        <form method="get" class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input id="txtstno" readonly type="text" runat="server" minlength="3" maxlength="3" required class="form-control" name="stno" disabled="true" aria-required="true">
                                </div>
                            </div>
                            <div class="form-group">
