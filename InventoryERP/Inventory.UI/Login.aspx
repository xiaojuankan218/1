<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Inventory.UI.Login" EnableEventValidation="false"%>
        ...
        <div class="row">
            ...
            <div class="col-sm-5">
                <form   runat="server">
                    ...
                    <input type="text" name="mname" class="form-control pword m-b" placeholder="姓名" />
                    <a href="#">忘记密码了？</a>
                    <asp:Button runat="server" ID="btnLogin" Text="登录" CssClass="btn btn-success btn-block" OnClientClick="return  true" OnClick="btnLogin_Click"/>
                </form>
            </div>
        </div>
